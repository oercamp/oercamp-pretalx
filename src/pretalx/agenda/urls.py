...
from .views import featured, feed, schedule, speaker, talk, widget, participants, venueless_embedded
        ...
        include(
            [
                ...
                *get_schedule_urls("schedule/v/<version>", "versioned-"),
                ...
                path("venueless/", venueless_embedded.VenuelessEmbedded.as_view(), name="venueless_embedded"),
                path(
                    "speaker/avatar.svg",
