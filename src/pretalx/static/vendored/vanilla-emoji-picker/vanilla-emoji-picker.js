const EmojiPicker = function(options) {
    ...
    const functions = {
        ...
        rePositioning: (picker) => {
            /**
             * NOVA: changed window.screen.availWidth to window.innerWidth
             */
            picker.getBoundingClientRect().right > window.innerWidth ? picker.style.left = window.innerWidth - picker.offsetWidth + 'px' : false;
